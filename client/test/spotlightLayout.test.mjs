...
const layout = (box, count, extra = {}) => computeSpotlightLayout({ ...box, count, ...extra });
...
function assertAspect(result, label) {
...
const screen = (id) => ({ key: id, screenId: id });
...
const camera = (key, extra = {}) => ({ key, audioId: key, ...extra });
